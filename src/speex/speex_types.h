...
#  include <inttypes.h>
   ...
   /* wasm32: speex_config_types.h is normally generated by speex's configure
      (absent here). Provide the same typedefs configure would emit for a 32-bit
      int / 16-bit short target. */
   typedef short spx_int16_t;
   typedef unsigned short spx_uint16_t;
   typedef int spx_int32_t;
   typedef unsigned int spx_uint32_t;
